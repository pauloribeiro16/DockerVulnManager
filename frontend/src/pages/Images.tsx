...
// Mock data - status derived from risk_score, not random
const mockImagesRaw = Array.from({ length: 14 }, (_, i) => ({
...
// Derive status from actual vulnerability data, NOT random
